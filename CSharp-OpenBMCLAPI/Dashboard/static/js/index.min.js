(() => {
    ...
    header.append(ttb.createElement("h3").setText(document.title))
        ...
        class Dashboard {
            constructor() {
                ...
                this._e_qps.setOption({
                    ...
                    tooltip: {
                        trigger: 'axis',
                        formatter: e => '<div style="margin: 0px 0 0;line-height:1;"><div style="margin: 0px 0 0;line-height:1;"><div style="font-size:14px;color:#666;font-weight:400;line-height:1;">' + e[0].name + '</div><div style="margin: 10px 0 0;line-height:1;"><div style="margin: 0px 0 0;line-height:1;"><div style="margin: 0px 0 0;line-height:1;"><span style="display:inline-block;margin-right:4px;border-radius:10px;width:10px;height:10px;background-color:#ad453f;"></span><span style="font-size:14px;color:#666;font-weight:400;margin-left:2px">QPS</span><span style="float:right;margin-left:20px;font-size:14px;color:#666;font-weight:900">Avg: ' + (e[0].data / 5) + " total: " + e[0].data + '</span><div style="clear:both"></div></div><div style="clear:both"></div></div><div style="clear:both"></div></div><div style="clear:both"></div></div><div style="clear:both"></div></div>',
                    },
                    stateAnimation: {
                        duration: 300,
                        easing: "cubicOut"
                ...
                this._page = [
                    ttb.createElement("div").class("panel").append(
                        ...
                        ttb.createElement("div").style("display: flex; justify-content: center").append(
                            ttb.createElement("button").setText("测速")
                        )
                    )
                ]
            }
